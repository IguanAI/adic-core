...
mod tests {
    ...
    async fn test_conflict_resolver_is_resolved() {
        ...
        resolver.update_support(&conflict_id, msg1, 10.0, 1).await.unwrap();
        resolver.update_support(&conflict_id, msg2, 1.0, 1).await.unwrap();
    ...
    async fn test_conflict_resolver_cleanup() {
        ...
        for i in 0..5 {
            ...
            resolver.update_support(&conflict_id, msg, 1.0, 1).await.unwrap();
        }
    ...
    async fn test_conflict_penalty_cap() {
        ...
        resolver.update_support(&conflict_id, msg1, 1000.0, 1).await.unwrap();
        resolver.update_support(&conflict_id, msg2, 1.0, 1).await.unwrap();
    ...
    async fn test_conflict_with_depth_factor() {
        ...
        resolver.update_support(&conflict_id, msg1, 10.0, 1).await.unwrap();
        resolver.update_support(&conflict_id, msg2, 10.0, 5).await.unwrap();
